...
write_rds(station_triplets_lookup, "C:/Users/vstromberg/OneDrive - DOI/Documents/FlowWest/NWI_Automation/riverware-nwi-main/data/swe_data/station_triplets_vs.rds")
