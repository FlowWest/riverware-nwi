...
net_inflow_export <- combined_net_inflow_smooth |>
  ...
  rowwise() |> 
  mutate(
         normalized_30_d_trailing_sum = round(normalize(ukl_net_inflow_30_d_trailing_sum_taf,observed_min_thirty_d_trailing_sum_uklni_taf,observed_max_thirty_d_trailing_sum_uklni_taf), 2)
         ) |> 
  ungroup() |> 
  dplyr::select(c(date, water_year, day_of_water_year, ukl_net_inflow_smoothed, ukl_net_inflow_30_d_trailing_sum_taf, normalized_30_d_trailing_sum))
