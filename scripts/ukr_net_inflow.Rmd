...
combined_net_inflow_smooth <- combined_net_inflow_smooth |> 
  ...
  mutate(date = as.Date(date, format= "%Y-%m-%d"),
         date = format(date, "%m/%d/%Y"))
write_csv(combined_net_inflow, here::here("data/combined_net_inflow.csv"))
write_csv(combined_net_inflow_smooth, here::here("data/combined_net_inflow_smooth.csv"))
```
