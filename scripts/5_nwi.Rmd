...
nwi <- prism_full |> 
  ...
  mutate(day_of_water_year = as.integer(day_of_water_year),
         normalized_weighted_avg_swe = if_else(day_of_water_year < 16 | (month > 6 & month <=9), 0, normalized_weighted_avg_swe)) |>
  ...
  mutate(weight_for_30_d_trailing_sum_UKLNI = day_of_water_year*wi_slope + wi_intercept,
         ...
         wetness_index_v20 =
           ...
           normalized_weighted_avg_swe*weight_for_normalized_weighted_avg_swe +
