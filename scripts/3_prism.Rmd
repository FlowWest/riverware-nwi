...
prism_start_date = as.Date("2025-3-31")
# prism_end_date = as.Date("2025-2-10")
...
```
```{r}
ppt_hist_archival <- read_csv(here::here("data/prism_data/archival_hist_prism_ppt.csv")) |> 
...
ppt_long_data <- bind_rows(ppt_hist_archival, ppt_archival) |> 
  arrange(date)
```
...
write_csv(ppt_data_export, here::here("data/prism_data/archival_prism_ppt_summary_export.csv"))
```
