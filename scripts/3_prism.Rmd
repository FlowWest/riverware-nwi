...
prism_start_date = as.Date("2025-2-01")
...
ppt_data_summary <- ppt_long_data |>
  ...
  mutate(weighted_mean_total_daily_precipitation_ukl_catchment_in = lag(
         ...
         thirty_d_trailing_sum_precip = rollsum(weighted_mean_total_daily_precipitation_ukl_catchment_in, k = 31, fill=NA, align = "right")
         ) |>
