...
Note: also first time generation will need historic data (back to Oct 2020) to generate the values for `trailing_sum_31_1095_d_precip_in`. This takes a long time to download and process 4 + years of data.
