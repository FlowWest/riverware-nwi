...
l1_taf <- l1_taf|> 
  mutate(thirty_d_trailing_sum_uklni_taf = lag(zoo::rollsum(I1_taf, k = 30, fill=NA, align = "right"), n=1)) |> glimpse()
...
net_inflow_export <- combined_net_inflow_smooth |>
  ...
  ungroup() |> 
  mutate(
    ukl_net_inflow_30_d_trailing_sum_taf = lag(zoo::rollsum(ukl_net_inflow_smoothed, k = 30, fill=NA, align = "right"), n=1)) |> 
