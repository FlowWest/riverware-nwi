...
full_normalized_df <- clean_n34_df|>
  ...
  mutate(normalized_CN34 = round(1 - normalize(N34, minimum_of_n34, maximum_of_n34), 2),
         ...
         normalized_pdo_cn34 = round(normalize(combined_pdo_cn34, minimum_of_pdo_cn34, maximum_of_pdo_cn34), 2)) |>View()
  dplyr::select(index, Year, month, N34, normalized_CN34, PDO, normalized_pdo)

write.csv(full_normalized_df, here::here("data/normalized_climated_indicies.csv"), row.names = FALSE)
```
